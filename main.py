...
loan_int_rate = st.number_input('Loan Interest Rate: ', step=0.1, value=None)
...
scaler = ['person_age', 'person_income', 'loan_amnt', 'loan_int_rate', 'cb_person_cred_hist_length', 'credit_score']
